...
const QUEUE_URL = 'https://sqs.us-east-1.amazonaws.com/551262695091/devsecops-lab-notifications-queue';
...
async function main() {
  ...
  for (const msg of Messages) {
    ...
    const order = event.detail; // EventBridge ya entrega 'detail' como objeto
